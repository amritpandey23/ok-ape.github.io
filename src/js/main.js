const project_list = [
  {
    ...
    description:
      "A simple front-end wrapper for DuckDuckGo search engine to search with finer details.",
  ...
  },
  {
    title: "flavoured.css",
    description:
      "Opinionated, Light-Weight and Cross-Browser stylesheet to make your webpage look better than nothing.",
  ...
  },
  {
    title: "CiphyBot",
    description:
      "A Simple discord bot that greets, logs and help mods deal with users.",
...
const close_modal_window_button = document.querySelector(
...
hide_menu_btn.addEventListener("click", (e) => {
  closeNav();
});
